...
function set_stats(received_data){
  ...
  document.getElementById("pkmn_name").innerText = "Pokemon name: " + received_data.name;  
  document.getElementById("pkmn_number_p").innerText = "Pokemon id: " + received_data.id;  
  document.getElementById("pkmn_weight_p").innerText = "Pokemon weight: " + received_data.weight/10 + "Kg";  
  document.getElementById("pkmn_height_p").innerText = "Pokemon height: " + received_data.height/10 + "M";
  document.getElementById("pkmn_type1_p").innerText = "Pokemon type: " + pokemon_type_1;
  document.getElementById("pkmn_hp_stat").innerText = "Pokemon HP: " + pokemon_stats[0];  
  document.getElementById("pkmn_attk_stat").innerText = "Pokemon Attack: " + pokemon_stats[1];  
  document.getElementById("pkmn_sattk_stat").innerText = "Pokemon Defense: " + pokemon_stats[2];  
  document.getElementById("pkmn_def_stat").innerText = "Pokemon Special attack: " + pokemon_stats[3];
  document.getElementById("pkmn_sdef_stat").innerText = "Pokemon Special defense: " + pokemon_stats[4];  
  document.getElementById("pkmn_speed_stat").innerText = "Pokemon Speed: " + pokemon_stats[5];
}
